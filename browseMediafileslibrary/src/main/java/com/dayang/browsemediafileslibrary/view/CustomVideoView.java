package com.dayang.browsemediafileslibrary.view;
...
public class CustomVideoView extends SurfaceView implements CustomMediaController.MediaPlayerControl {
	private String TAG =  "fengao";
    private Uri mUri;
